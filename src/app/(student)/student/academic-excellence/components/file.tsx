...
function DocumentShow() {
    ...
    return (
        <div className={`sm:px-20 py-5 ${isOpenPay ? 'flex justify-between space-x-5' : ''}`}>
            <div className={`${isOpenPay ? 'w-[70%]' : ''}`}>
                ...
                <div className='flex space-x-4 mt-5'>
                    <button className='border border-gray-700 bg-gray-100 text-gray-700 text-base font-semibold rounded-md py-2 px-6 hover:border-gray-100 hover:bg-gray-700 hover:text-gray-100 transition-all' onClick={() => setIsOpenPay(!isOpenPay)}>Proceed</button>

                    <button className='border border-gray-500 bg-gray-700 text-gray-100 text-base font-semibold rounded-md py-2 px-6 hover:border-gray-700 hover:bg-gray-100 hover:text-gray-700 transition-all'>Reject & Re-generate</button>
                </div>
            </div>
            {isOpenPay && <div className='w-[30%]'>
                                ...
                                <form action="#" className="w-full rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-card lg:max-w-xl">
                                    <div className="mb-6 space-y-5">
                                        <div className="col-span-2 sm:col-span-1">
                                            ...
                                            <input type="text" id="full_name" className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900  focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark: dark:focus:ring-primary-500" placeholder="Bonnie Green" required />
                                        </div>

                                        <div className="col-span-2 sm:col-span-1">
                                            <label htmlFor="card-number-input" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Card number* </label>
                                            <input type="text" id="card-number-input" className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pe-10 text-sm text-gray-900  focus:ring-primary-500  dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark: dark:focus:ring-primary-500" placeholder="xxxx-xxxx-xxxx-xxxx" pattern="^4[0-9]{12}(?:[0-9]{3})?$" required />
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                <div className="pointer-events-none absolute inset-y-0 start-0 flex items-center ps-3.5">
                                                    <svg className="size-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                                        <path
                                                            fill-rule="evenodd"
                                        ...
                                        <div>
                                            ...
                                            <input type="number" id="cvv-input" aria-describedby="helper-text-explanation" className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900  focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark: dark:focus:ring-primary-500" placeholder="•••" required />
                                        </div>
                                    </div>
